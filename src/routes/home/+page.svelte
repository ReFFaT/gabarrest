...
<section>
    <div class="main-bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6>САМАЯ ИНТЕРЕСНАЯ ЕДА В МИРЕ</h6>
                    <h1>Откройте для себя <span class="prime-color">вкус</span><br>
                    <span class="style-change">еды <span class="prime-color">от </span>flavors </span></h1>
                </div>
            </div>
        </div>
    </div>
